...
func linkshellCrossworldMembersJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "linkshell/crossworld/members.json", size: 1551, mode: os.FileMode(438), modTime: time.Unix(1608706717, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func metaJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "meta.json", size: 2496, mode: os.FileMode(438), modTime: time.Unix(1608706723, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
