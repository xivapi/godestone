...
func metaJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "meta.json", size: 2446, mode: os.FileMode(438), modTime: time.Unix(1608874111, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
